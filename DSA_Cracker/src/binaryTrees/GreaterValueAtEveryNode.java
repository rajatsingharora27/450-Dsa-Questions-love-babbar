...
public class GreaterValueAtEveryNode {
	...
	public static void greterValue(Node<Integer> root) {

		printLevelOrder(helpler(root));
	...
	private static Node<Integer> helpler(Node<Integer> root) {
